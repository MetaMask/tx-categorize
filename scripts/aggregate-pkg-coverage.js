...
/**
 * Generates a report for each package and copies it to the temp reports dir
 */
        ...
        fs.stat(itemPath, (error, stats) => {
          ...
          if (stats.isDirectory()) {
            ...
            try {
              ...
              execSync('yarn test --coverage --silent --passWithNoTests', { cwd: itemPath, stdio: 'inherit' })
