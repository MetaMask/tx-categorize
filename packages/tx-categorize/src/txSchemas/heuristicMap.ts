...
const determinants: DeterminantMap = {
  ...
  methodIds: [
    ...
    { id: '0x14d53077', name: BRIDGE_WITHDRAW, priority: 1, protocol: 'LIFI' }, // lifi
    { id: '0xa6010a66', name: BRIDGE_WITHDRAW, priority: 1, protocol: 'LIFI' }, // lifi
    ...
    { id: '0xdeff4b24', name: BRIDGE_DEPOSIT },
    ...
    { id: '0x0f4d14e9', name: BRIDGE_DEPOSIT },
    { id: '0x9c5cfe0b', name: BRIDGE_WITHDRAW },
  ...
  topics: [
    ...
    { hash: '0x936c2ca3b35d2d0b24057b0675c459e4515f48fe132d138e213ae59ffab7f53e', name: BRIDGE_WITHDRAW },
    ...
    { hash: '0xcba69f43792f9f399347222505213b55af8e0b0b54b893085c2e27ecbe1644f1', name: BRIDGE_WITHDRAW },
    {
    ...
    { hash: '0x74594da9e31ee4068e17809037db37db496702bf7d8d63afe6f97949277d1609', name: BRIDGE_WITHDRAW },
    { hash: '0x7d7fb03518253ae01913536628b78d6d82e63e19b943aab5f4948356021259be', name: EXCHANGE },
    { hash: '0x28fd8a5dda29b4035905e0657f97244a0e0bef97951e248ed0f2c6878d6590c2', name: BRIDGE_WITHDRAW },
